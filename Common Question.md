# Part 1. 239 Question and answer
# ================================
...
A. माइक्रोसॉफ़्ट एक्सचेंज (Microsoft Exchange)
B. IMAP
C. POP 3
D. HTTP
...
D. आउटबॉक्स पर क्लिक करके

Right Answer is: B


Q. 215. एमएस-एक्सेल 2010 में स्ट्रिंग के शुरू और अंत के रिक्त स्थान और डुप्लिकेट रिक्त स्थान को हटाने के लिए ________ फंक्शन का इस्तेमाल किया जाता हैं।
...
Q. 216. निम्न में से कौन सा फंक्शन एमएस एक्सल 2010 में टेक्स्ट स्ट्रिंग की लंबाई देता है?
...
Q. 217. एक _______ कुंजी में एक या एक से अधिक फील्ड होती है जो एमएस एक्सैस (MS Access) में प्रत्येक रिकॉर्ड को विशिष्ट रूप से तालिका (टेबल) के रूप इन पहचानती हैं।

A. टेक्स्ट (Text)
B. फील्ड (Field)
C. सेकेंडरी (Secondary)
D. प्राइमरी (Primary)

Right Answer is: D


Q. 218. इनमे से पेन ड्राइव की विशेषता नही है?

A. यह ऑप्टिकल ड्राइव का एक उदाहरण है
B. यह यू. एस. बी. पोर्ट के माध्यम से जुड़ता है
...
Q. 219. एम.एस.-वर्ड में _______ विकल्प पेज की सामग्री के पीछे फीकी पाठ (ghosted text) सम्मिलित करने लिए प्रयोग किया जाता है?

A. वॉटर मार्क (watermark)
B. पेज कलर (page color)
C. मार्जिन (margin)
D. हायफ़नेशन (Hyphenation)

Right Answer is: A


Q. 220. फ्लो चार्ट्स (flow charts) योजना बनाने का एक उपकरण है, आम तौर पर निम्न का प्रतिनिधित्व करने के लिए इस्तेमाल किए जाते है?
...
Q. 221. कौनसी कीबोर्ड शोर्ट्कट को चयनित आइटम का नाम बदलने के लिए प्रयोग किया जाता है?
...
Q. 222. उपयोगकर्ता को नजर समायोजित करने और कम्प्युटर के महसूस (जैसे डेस्कटॉप बैकग्राउंड ,थीम इत्यादि ) करने के लिए कौन सा विकल्प अनुमति देता है?

A. अपीयरेंस और पेरसोनलाइजेशन (Appearance and personalization)
B. प्रोग्राम्स और फीचर्स (programs and Features) (ilearnrscit.com)
...
Q. 223. MS Excel chart में डेटा बिंदु के वास्तविक मूल्य को कहा जाता है?
...
Q. 224. निम्नलिखित में से कौन सा DBMS का लाभ नही है?
...
Q. 225. निम्न में से सर्वाधित वास्तविक (Augmented Reality) का उदाहरण है?
...
Q. 226. ________ आमतौर पर एक चर्चा या सूचनात्मक वैबसाइट होती है जोकि असतत प्रविष्टिया (discrete entries) जिन्हें पोस्ट कहते है, से मिल कर बनी होती है?
...
Q. 227. 'C:\VMOU\RSCIT\file.bmp’ फ़ाइल पथ (path) में ‘ \ ’________ का प्रतिनिधित्व करते हैं?
               
A. सेपरेट (Seprate)
B. ड्राइव (Drive) के नाम
C. सबफ़ोल्डर (Subfolder)
D. उच्च – स्तरीय फोंल्डर

Right Answer is: A


Q. 228. आई. पी. पते का मान्य उदाहरण है?
...
Q. 229. Email भेजते वक्त, अगर ईमेल पते को ________ फील्ड में डाले तो प्राप्तकर्ता व्यक्ति को ईमेल मिल जाएगा, लेकिन वह कोई अन्य प्राप्तकर्ता का ईमेल पता नही देख पाएगा जोकि उपरोक्त फील्ड में है?
...
Q. 230. एमएस - एक्सैस 2010 में नव निर्मित डेटाबेस का डिफ़ाल्ट फ़ाइल फ़ारमैट (file format) क्या होता है?
...
Q. 231. डोमेन नाम (domainname) का पता लगाने और इसे इंटरनेट प्रोटोकॉल एड्रैस (addresses) में अनुवाद करने के लिए निम्न में से कौन उत्तरदायी है?
...
Q. 232. ई-मेल पते का सही उदाहरण क्या है? निम्नलिखित से सबसे उपयुक्त विकल्प चुनें?
...
Q. 233. एमएस वर्ड 2010 में आपको कौन सा मेनू टैब फॉन्ट शैली बदलने की अनुमति देता है?
...
Q. 234. विंडोज 10 में टास्कबार का मूलभूत स्थान कहाँ होता है?
...
Q. 235. एम . एस. – वर्ड में ________ बार पर दस्तावेज़ का नाम दिखाता है?
...
Q. 236. ऐसी कुंजी जो किसी फंक्शन को चालू या बंद करती है उसे _______ कुंजी कहा जाता है?
...
Q. 237. निम्न में से कौनसा हार्डवेयर का उदाहरण नही है?
...
Q. 238. निम्न में से कौन ऑपरेटिंग सिस्टम के उदाहरण नहीं है?
...
Q. 239. ए.एल.यू. (ALU) का पूरा रूप क्या है?
               
A. अरिथमेटिक लॉजिक यूनिट (Arithmetic Logic Unit)
B. अस्सकी लॉजिक यूनिट (ASCII Logic Unit)
C. एलाउडलॉजिक यूनिट (Allowed Logic Unit)
D. अरिथमेटिक लीस्ट यूनिट (Arithmetic Least Unit)

Right Answer is: A

# Part 2. 150 Question and answer
# ================================

1. इंक-जेट प्रिन्टर्स या बैण्ड प्रिन्टर्स को वर्गीकृत किया जाता है जैसे –
...
(A) सॉलिड स्टेट ड्राइव (Solid State Drive)
(B) हार्ड डिस्क (Hard Disk)
(C) रैंडम एक्सेस मेमोरी (Random Access Memory)
(D) यूएसबी पेन ड्राइव (USB Pen Drive)
...
7. एम.एस, वर्ड 2010 के किस टैब (Tab) में हैडर और फूटर विकल्प उपलब्ध हैं?
...
(A) ड्रॉपबॉक्स (Drop Box)
(B) वे टू एस.एम.एस. (Way To SMS)
(C) पे.टीएम. (PayTM)
(D) मोस्टर इंडिया (Monster India)
...
(C) पिक्चर (Picture)
(D) इनमें से कोई नहीं (None Of The These)
...
(B) आउटलाइनव्यू (Outline View)
(C) स्लाइड लेआउट विकल्प (Slide Layout Options)
(D) प्रेजेंटेशन डिजाइन टैंप्लेट Presentation Design Template
...
17. दस्तावेजों को सेव करते समय, “सेव” (Save) और “सेव एज”(SaveAs) में अंतर है:

(A) कोई भी अन्तर नही है।
(B) ‘सेव’ (Save) उस दस्तावेज को संग्रहीत करेगा जो पहले से ही किसी स्थान में संग्रहीत है।
(C) ‘सेव एज’ (SaveAS) हमें फाइल का नाम और स्थान बदलने की अनुमति देता है।
(D) B और C दोनों

Answer : D

18. पॉवर पॉइंट प्रदर्शन में कौन सा फाइल प्रारूप नहीं जोड़ाजा सकता है:
...
(B) कैलकुलेटर (Calculator)
(C) म्यूजिक प्लेयर (Music Player)
(D) चैट रूम (Chat Room)
...
(A) डुअल इन-लाइन मल्टी मीडिया मॉडल (Dual Inline Multimedia Model)
(B) डुअल इंटरचेंज मेमोरी मॉडल (Dual Interchange Memory Model)
(C) डुअल इन-लाइन मेमोरी मोड्यूल (Dual Inline Memory Module)
(D) डिवाइडेड इन-लाइन मल्टी मीडिया मॉडल (Divided Inline Multimedia Model)
...
24. विंडोज में किसी फाइल या फोल्डर को हमेशा के लिए मिटाने हेतु, हम इस्तेमाल करते हैं:
...
25. टिम बेर्नेर्स ली (Tim Berners Lee) द्वारा दी गयी अवधारणा है:

(A) WWW
(B) HTML
(C) सिमेंटिक वेब (Semantic Web)
...
(A) सीरियल एडवांसमेंट टेक्नोलॉजी अटैचमेंट (Serial Advanced Technology Attachment)
(B) सिंपल एडवांस्ड टेक्नोलॉजी अटैचमेंट (Simple Advanced Technology Attachment)
(C) सीरियल एडवांस्ड टेक्नोलॉजी अटैचमेंट (Serial Advanced Technology Attachment)
(D) सीरियल एडवांस्ड टर्मिनोलॉजी अटैचमेंट (Serial Advanced Terminology Attachment)
...
(A) इंच (Inches)
(B) पिक्सेल (Pixels)
(C) सेंटीमीटर (Centimeters)
(D) परसेंटेज (Percentage)
...
(C) एम.एस. पॉवर प्वाइंट (MS Power Point)
(D) एम.एस. वर्ड (MS Word)

Answer : A

33. कम्प्यूटर सिस्टम का एक हिस्सा जिसमें कम्प्यूटर निर्देशों पर डेटा होता है।
...
(A) माउस (Mouse)
(B) की-बोर्ड (Keyboard)
(C) मेमोरी डिवाइस (Memory Devices)
(D) डी.वी.डी. (DVD)
...
(A) लाइन प्रिंटर (Line Printers)
(B) ऑफ-बैण्ड प्रिंटर (Of-Band Printers)
(C) कैरेक्टर प्रिंटर (Character Printers)
(D) इंक प्रिंटर (Ink Printers)

Answer : C

36. कंप्यूटर का जनक किसे कहा जाता है?
...
37. भारत में निर्मित पहला कंप्यूटर कौन सा है।
...
38. Graphical Table में क्या उपयोग होता हैं?
...
39. एक प्राइमरी Key में होती हैं ?
...
40. किसी शब्द के बारे में उसी पेज के नीचे लिखा गया छोटा विवरण कहलाता है।
...
41. Google Drive में हम कितने GB तक डेटा स्टोर कर सकते हैं ?
...
42. Windows 10 में Snap Assist का क्या उपयोग हैं ?
...
43. ज्यादातर लेज़र प्रिंटर होते हैं ?
...
44. एक सर्च इंजन द्वारा सूचनाओं को खोजने के लिए किसका उपयोग किया जाता है?
...
45. नेटवर्क कनेक्शन डिवाइस का एक उदाहरण हैं ?
...
47. निम्न में से RAM के प्रकार कौन–कौनसे हैं ?
...
48. निम्न में से कौनसी ऑप्शन टास्कबार में मौजूद नहीं होती ?
...
49. मोबाइल ऑपरेटिंग सिस्टम का उदाहरण कौनसा हैं ?
...
50. किस प्रकार की ROM बिजली के सिग्नल्स से मिटाई जा सकती हैं?
...
51. डिजिटल हस्ताक्षर का उपयोग किसके साथ कर सकते हैं?

(A) पीडीएफ डॉक्यूमेंट

(B) ईमेल संदेश

(C) वर्ड प्रोसेसिंग डॉक्यूमेंट

(D) उपरोक्त सभी

Answer: D

52. Booting कितने प्रकार की होती हैं ?
...
53. निम्न में से नेटवर्क के प्रकार नहीं हैं ?
...
54. URL किस Bar में Show होता हैं ?
...
56. HTML का प्रयोग किया जाता है
...
57. स्टोरेज युक्ति का विस्तारित रूप है:-

(A) युनिवर्सल सिंगल बस

(B) युनिवर्सल सर्विस बस

(C) युनिवर्सल सोशल बस

(D) युनिवर्सल सेटेलाइट बस

Answer : A

58. किसी टेक्स्ट के स्ट्राइक थ्रू का तात्पर्य क्या है–
...
59. पॉवर पॉइंट प्रस्तुतिकरण में हाइपरलिंक को इन्सर्ट करने हेतु किस सक्षिप्त कीज के संयोग का प्रयोग किया जाता है:-
...
60. वेबसाइट का मुख्य पृष्ठ कहलाता है–
...
61. दशमलव संख्या का आधार होता है
...
62. विंडोज में किसी भी फाइल अथवा फोल्डर को पूर्ण रूप से मिटाने हेतु, दबाया जाता है–
...
63. MS वर्ड में CTRL+RETURN का प्रयोग किया जाता है
...
64. स्लाइड ओरिएनटेसन हेतु विकल्प हैं?
...
66. विंडोज मिडिया प्लेयर का प्रयोग किया जाता है–

(A) प्रोग्राम को संकलित करने हेतु

(B) ऑडियो व वीडियो फाइल को रन करने हेतु
...
68. रेंडम एक्सेस मेमोरी एक प्रणाली है–
...
71. MS पॉवरपॉइंट में स्लाइड शो को करने हेतु शार्टकट कीज क्या है
...
72. निम्न में से कोन सा सर्च इंजन नही है
...
73. रिफ्रेश करने हेतु की (KEY) का प्रयोग किया जाता है?
...
74. MS एक्सेल में चयनित सेल्स का फिल्टरिंग किया जाता है:
...
75. एक कंप्यूटर में Function कीज की कुल संख्या होती है
...
76. MS पेंट में किसी भी तस्वीर को _____ फोर्मेट में सुरक्षित नही किया जाता है?
...
77. कंप्यूटर में आकडे संग्रहित करने के संदर्भ में निम्न में से कोन सबसे बड़ी इकाई है–
...
78. MS Excel में किसी फंक्शन को इन्सर्ट करने हेतु निम्न में से किस शार्टकट कीज का प्रयोग किया जाता है–
...
79. MS पॉवर पॉइंट 2010 में डेकोरेटिव टेक्स्ट को इन्सर्ट करने हेतु _____का प्रयोग किया जाता है–
...
81. किसी भी चयनित टेक्स्ट को रेखांकित करने के लिए,दबाया जाता है
...
82. वर्कशीट पर होरिजोन्टल और वर्टीकल लाइनों को कहते हैं।
...
83. कंट्रोल पैनल में कौन–कौनसे ऑप्शंस पाये जाते हैं ?
...
84. निम्न में किस सर्च इंजन का विकास माइक्रोसॉफ्ट ने किया है?
...
85. एक नेटवर्क गेटवे _______ होता हैं।
...
86. जब आप किसी इमेज का चुनाव करते हैं तो क्या प्रदर्शित होता है?
...
87. विण्डोज महत्वपूर्ण फाइलों को कहाँ स्टोर करती है?
...
88. एक्सेल में आप किस प्रकार सम्पूर्ण कॉलम सलेक्ट कर सकते हैं?
...
89. निम्न में से सर्च इंजन नहीं हैं ?
...
90. व्हाट्सएप (Whatsapp) का उपयोग किस कार्य में किया जाता है?
...
91. निम्न में कौन सा मोबाइल वॉलेट का उदाहरण नहीं है?
...
92. आपकी Query के अनुसार सर्च इंजन एक सूची प्रदर्शित करता है, इसे कहते हैं।
...
93. निम्न में से कौनसी ऑप्शन E-mail फोल्डर में नहीं होती ?
...
94. डाइरेक्टरी के अंदर की डाइरेक्टरी को कहा जाता है?
...
96. भारत में सर्वप्रथम दिखाई देने वाला कंप्यूटर वाइरस है –
...
98. कंप्यूटर साक्षरता दिवस कब मनाया जाता है ?
...
99. पहले से चल रहे कंप्यूटर को रीस्टार्ट करना कहलाता है ?
...
100. सीपीयू का वह भाग जो अन्य सभी कंप्यूटर कंपोनेन्टस की गतिविधियों को कोआर्डिनेट करता है
...
101. एक आउटपुट डिवाइस का एक उदाहरण हैं
...
102. निम्न में से कोनसा एक एप्लीकेशन सॉफ्टवेर नहीं हैं
...
103. सबसे तेज कंप्यूटर कोनसा हैं –
...
104. निम्नलिखित में से कोन सा, कंप्यूटर हार्डवेयर को चलाता है और अन्य सॉफ्टवेर चलाने के लिए एक मंच के रूप में कार्य करता है ?
...
105. निम्न में से कोनसी कंप्यूटर सिस्टम की एक सीमा हैं
...
106. निम्न में से कोनसा एक सिस्टम सॉफ्टवेर का उदाहरण हैं
...
107. कोनसा कंप्यूटर वर्गीकृत नहीं हैं
...
108. निम्‍नलिखित में से कौन कम्‍प्‍यूटर के गुण है।
...
109. कम्‍प्‍यूटर साक्षरता दिवस मनाया जाता हैं।
...
110. कम्‍प्‍यूटर प्रोसेस द्वारा इन्‍फार्मेशन में परिवर्तित करता हैं।
...
111. कम्‍प्‍यूटर निम्‍नलिखित में से कौन सा कार्य नहीं करता हैं।
...
112. भारत का पहला कम्‍प्‍यूटर कहां स्‍थापित किया गया था।
...
113. इनमें से कौन कम्‍प्‍यूटर का गुण नहीं हैं।
...
114. इनमें से कौन सा एक सर्च इंजन नहीं है ?
...
115. निम्न में से कौनसा एक कम्प्यूटर के प्रोसेसर का प्रकार नहीं है
...
116. 1 किलोबाइट (KB) बराबर होते है ?
...
117. चुम्बकीय डिस्क पर किस पदार्थ की परत चढ़ी होती है
...
118. निम्न में से कोनसा एक ब्रॉउज़र नहीं है
...
119. कंप्यूटर में जाने वाले डेटा को क्या कहते हैं?
...
120. इनमें से प्वाइंट एंड ड्रॉ डिवाइस कहा जाता है
...
121. 1 पेंटा बाइट (PB) में कितने बाइट होते है ?
...
122. इन्टरनेट के पते में http का विस्तृत रूप है ?
...
124. वह मेमोरी जिसमें रखा डाटा बिजली जाते ही समाप्त हो जाता है?
...
126. किसी नेटवर्क में डाटा ट्रांसफर की गति को किसमें मापा जाता है?
...
127. निम्न में से कौन सा चार्ट का प्रकार एक्सेल 2010 में नहीं होता है?
...
128. एमएस वर्ड 2010 में फॉर्मेट पेंटर का उपयोग करके विशिष्ट पाठ के प्रारूप की प्रतिलिपि बनाने के लिए शॉर्टकट कुंजी क्या हैं?
...
129. एमएस एक्सेस 2010 में उपयोगकर्ता या तो ______ व्यू या ______ व्यू में एक नई टेबल बना सकता है?

(A). डिजाइन, डाटाशीट

(B). फार्मूला, प्रिंट

(C). टेक्स्ट, नंबर (ilearn rscit.com)

(D). बुकमार्क, हाइपरलिंक

Answer : A

130. ऑप्टिकल डिस्क का उदाहरण कौनसा है?
...
131. ______ एम्बेडेड भौतिक वस्तुओं (embedded physical objects) का नेटवर्क है जो इलेक्ट्रोनिक, सॉफ्टवेयर, सेन्सर और नेटवर्क कनेक्टिविटी के साथ इन वस्तुओं को क्लाउड (cloud) पर डेटा एकत्र करने और विनमय करने में सक्षम बनाता है?
...
132. वर्कशीट में एक क्षेत्र से स्वरूपण की प्रतिलिपि बनाने के लिए और किसी दूसरे क्षेत्र में लागू करने के लिए आप प्रयोग करेंगे?
...
134. DBMS, ACID प्रॉपर्टी का अनुसरण करता है, ACID का मतलब है?
...
135. निम्न में से किस कुंजी की मदद से आप Cursor के दाएं और के अक्षरों को Delete कर सकते है?
...
136. पेज ओरियेंटेशन ऑप्शन निम्न में से किस टैब में उपलब्ध है?
...
138. दस्तावेज में एक नया पैराग्राफ दर्ज करने के लिए _ कुंजी का इस्तेमाल किया जाता है? 
...
139. निम्नलिखित में से किस व्यू की मदद से आप टेक्स्ट या ग्राफिक का प्रिंट से पहले पूर्वालोकन कर सकते है?
...
140. पोट्रेट एवं लैंडस्केप क्या है?
...
141. निम्नलिखित में से किसका इस्तेमाल कर आप डॉक्यूमेंट के मोड को Portrait से Landscape में बदल सकते है?
...
142. वर्ड 2010 में रिबन किसकी एक श्रृखला से बनता है?
...
143. दस्तावेज में Header और Footer डालने का मुख्य उदेश्य क्या होता है?

(A) दस्तावेज की दिखावटी को सुधारने के लिए  

(B) प्रष्ट के प्रारभ और समापन को चिन्हित करने के लिए   

(C) बड़े दस्तावेज को अधिक पठनीय बनाने के लिए 

(D) मुद्रित होने पर प्रष्ट हैडर और फूटर दस्तावेज पर दिखाई देने के लिए  

Answer : A

144. इनमे से कौन सा फीचर सिलेक्टेड एरिया के फोर्मटिंग को हटाता है?
...
145. निम्न में से किन के सयोंजन से एक्सेल वर्कबुक बनाता है?
...
146. Microsoft Excel 2010 में चयनित सेल में से एक चार्ट बनाने के लिए निम्न में से किस शॉर्टकट कुंजी का इस्तेमाल किया जाता है?
...
147. एक्सेल 2003, 2007, 2010 का File एक्सटैंशन क्या होता है? 
...
148. जब आप एक फार्मूला कॉपी करते है? 

(A) एक्सेल फार्मूला की मूल प्रति मिटा देता है

(B) एक्सेल न्यूली कॉपीड फार्मूला में सेल रेफरेंस संपादन करता है

(C) एक्सेल अब्सोल्युट सेल रेफरेंस को समायोजित करता है 

(D) एक्सेल रिलेटिव सेल रेफरेंस को समायोजित नही करता है

Answer : B

149. माइक्रोसॉफ्ट एक्सेल 2010 का उपयोग कर निम्न में से कौनसे चार्ट के प्रकार बनाए जा सकते है?
...
150. आमतौर पर किस प्रकार का ईमेल खाता व्यापार Setting में उपयोग किया जाता है?
